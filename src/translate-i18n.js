    ...
    resources: {
      ko: {
        ...
        "K9A1": {
          ...
          "highMobility": "K9 자주포의 강력한 파워팩은 유기압 현수장치와 결합되어, 최대 67km/h의 기동성과 사격충격을 완화하여 사격 후 신속한 진지 이탈로 아군의 생존성을 높이고, 사격 정확도를 향상시켰습니다.",
          "ammunitionLoader": "K9 자주포는 최대 48발의 탄약 적재 능력을 갖추고 있으며,<br/> 포탄은 적재부터 이송, 장전까지의 과정을 자동화하여 신속한 화력집중 사격이 가능합니다. ",
          "automaticControlSystem": "자동 사격통제장치와 GPS를 적용하여 사격정확성과 운용 효율성을 증대하였으며, 디지털 지도와 전자식 교범을 탑재하여 운용 편의성을 향상 하였습니다.",
          "irCamera": "조종수 야간잠만경을 열상형으로 적용하여 야간 기동성을 향상 시켰으며, 전/후방 카메라 장착으로 기동간 안전을 확보하였습니다.",
        },
        "REDBACK": {
          "title": "레드백",

  ...
  i18next.init({
    ...
    resources: {
      ko: {
        ...
        "K9A1": {
          "title": "K9 자주포",
          "longerFiringRange": "K9 자주포는 360도 전방위 사격이 가능한 자주포로, K307탄을 활용하여 40km의 화력 지원이 가능하고, NATO 규격탄과의 호환이 가능하며, 최대 6~8발/분, 3발/15초, 기동간 60초 이내 사격이 가능합니다.",
          "highMobility": "K9 자주포의 강력한 파워팩은 유기압 현수장치와 결합되어, 최대 67km/h의 기동성과사격충격을 완화하여 사격 후 신속한 진지 이탈로 아군의 생존성을 높이고, 사격 정확도를 향상시켰습니다.",
          "ammunitionLoader": "K9 자주포는 최대 48발의 탄약 적재 능력을 갖 추고 있으며,<br/> 포탄은 적재부터 이송, 장전까지 의 과정을 자동화하여 신속한 화력집중 사격이 가능합니다. ",
          "automaticControlSystem": "자동 사격통제장치와 GPS를 적용하여 사격정확 성과 운용 효율성을 증대하였으며, 디지털 지도 와 전자식 교범을 탑재하여 운용 편의성을 향상 하였습니다.",
          "irCamera": "조종수 야간잠만경을 열상형으로 적용하여 야간 기동성을 향상 시켰으며, 전/후방 카메라 장착으 로 기동간 안전을 확보하였습니다.",
        },
        "REDBACK": {
          "title": "레드백",
      ...
      en: {
        ...
        "K9A1": {
          ...
          "ammunitionLoader": "The K9 self-propelled howitzer can carry up to 48 rounds of ammunition at maximum capacity. <br> With full automation of the ammunition supply, transportation, and loading process, the K9A2 self-propelled howitzer currently under development is expected to have a much-improved firing speed",

    ...
    resources: {
      ko: {
        "GATE": {
          ...
          "guide2": "<em>다양한 환경</em>에서도 최적화되어있는 <span class='guide-product-name'>K9A1</span>의 모습을 확인해보세요",
          "guide3": "<em><span class='guide-product-name'>K9A1</span></em> 더 자세히 알아보세요",
          "close": "닫기",
        },
        "K9A1": {
          "longerFiringRange": "K9A1 자주포는 360도 전방위 공격이 가능한 자주포로, K307탄을 활용하여 40km의 화력 지원이 가능하고 NATO 규격탄과의 호환이 가능하도록 개발했습니다. 사격정보를 받은 뒤 기동간 60초 이내, 정지간 30초 이내 사격이 가능합니다.",
          "highMobility": "K9A1자주포의 강력한 파워팩은 유기압 현수장치와 결합되어, 최대 67km/h 빠른 속도와 높은 사격정확도. 그리고 사격 후의 신속한 진지 이탈이 가능하여 아군의 생존성을 높입니다.",
      ...
      en: {
        "GATE": {
          ...
          "guide2": "Check out the <span class='guide-product-name'>K9A1</span> that's optimized<br> in <em>any operational environment</em>",
          "guide3": "Learn more about <em><span class='guide-product-name'>K9A1</span></em>",
          "close": "Close",
        },
        "K9A1": {
          "longerFiringRange": "The K9A1 self-propelled howitzer is capable of 360-degree attacks. In addition, using K307 rounds, it is possible to support 40km of firepower and is compatible with NATO standard ammunition. After receiving the shooting information, it can fire within 60 seconds between maneuvers and within 30 seconds between stops.",
          "highMobility": "The powerful power pack of the K9A1 self-propelled howitzer is combined with a Hydropneumatic Suspension Unit, resulting in a high speed of up to 67 km/h and high firing accuracy. In addition, it can quickly leave the camp after firing, increasing the survivability of the allies.",
